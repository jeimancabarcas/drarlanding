  ...
  template: `
    <section id="especialidades" class="py-24 bg-white">
      <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-20 title-anim opacity-0 translate-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 services-grid">
          ...
          <div class="service-card opacity-0 translate-y-12 group rounded-3xl overflow-hidden bg-slate-50 hover:bg-white border border-slate-100 hover:border-blue-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
             ...
             <div class="p-8">
               ...
               <a href="#contacto" class="text-blue-600 font-bold text-sm hover:underline flex items-center gap-1 group/link">
...
export class SpecialtiesComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.ctx = gsap.context(() => {
      ...
      // Batch Services Animation for performance and style
