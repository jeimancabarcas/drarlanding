      ...
      <div class="max-w-7xl mx-auto px-6 lg:px-8 w-full relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div class="lg:col-span-6 order-2 lg:order-1 space-y-8 text-center lg:text-left">
            <div class="hero-text-block opacity-0 translate-y-8">
            ...
            <p class="hero-text-block opacity-0 translate-y-8 text-xl text-slate-600 leading-relaxed max-w-lg mx-auto lg:mx-0 font-normal">
            ...
            <div class="hero-text-block opacity-0 translate-y-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
            ...
            <!-- Trust Badges -->
            <div class="hero-text-block opacity-0 translate-y-8 pt-8 flex flex-wrap gap-8 justify-center lg:justify-start opacity-80">
          ...
          <!-- Image Content -->
          <div class="hero-image-wrapper lg:col-span-6 order-1 lg:order-2 relative opacity-0 scale-90">
             ...
             <div class="hero-image relative rounded-[2rem] overflow-hidden shadow-2xl shadow-blue-200/50 aspect-[4/5] md:aspect-square lg:aspect-[4/5] bg-white ring-8 ring-white">
                <!-- Using a seed to approximate the look of the 'Standing Doctor in Blue' image provided -->
                <img 
                ...
                <!-- Floating Card -->
                <div class="hero-card absolute bottom-6 right-6 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-lg max-w-[200px] border border-white/50 opacity-0 translate-y-4">
