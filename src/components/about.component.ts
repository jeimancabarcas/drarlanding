        ...
        <div class="flex flex-col md:flex-row gap-16 items-center">
          ...
          <div class="w-full md:w-1/2 relative about-images">
             <div class="grid grid-cols-2 gap-4">
                ...
                <img src="https://picsum.photos/seed/surgery_blue_scrubs/800/600" class="about-img rounded-2xl shadow-lg w-full h-64 object-cover mt-8" alt="Cirugía y Procedimientos">
                
                <!-- Image matching the 'Aesthetic Injection' -->
                <img src="https://picsum.photos/seed/facial_injection_aesthetic/800/600" class="about-img rounded-2xl shadow-lg w-full h-80 object-cover" alt="Procedimientos Estéticos">
             </div>
             <!-- Decorative elements -->
             <div class="absolute -z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[110%] h-[90%] bg-blue-50 rounded-[3rem] about-bg"></div>
          </div>

          <!-- Text Bio -->
          <div class="w-full md:w-1/2 about-text">
            <span class="text-blue-600 font-bold tracking-wider uppercase text-xs mb-2 block reveal-text">¿Quién soy?</span>
            <h2 class="text-3xl md:text-4xl font-bold text-slate-900 mb-6 reveal-text">Dr. Andres Rivera Ariza</h2>
            ...
            <div class="mt-8 flex flex-wrap gap-3">
               <span class="skill-tag px-4 py-2 bg-blue-50 text-blue-700 rounded-lg text-sm font-semibold hover:bg-blue-100 transition-colors cursor-default">Integralidad</span>
               <span class="skill-tag px-4 py-2 bg-blue-50 text-blue-700 rounded-lg text-sm font-semibold hover:bg-blue-100 transition-colors cursor-default">Arte & Ciencia</span>
               <span class="skill-tag px-4 py-2 bg-blue-50 text-blue-700 rounded-lg text-sm font-semibold hover:bg-blue-100 transition-colors cursor-default">Liderazgo</span>
               <span class="skill-tag px-4 py-2 bg-blue-50 text-blue-700 rounded-lg text-sm font-semibold hover:bg-blue-100 transition-colors cursor-default">English Spoken</span>
            </div>
          </div>
