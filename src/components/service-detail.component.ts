  ...
  template: `
    <div class="pt-24 min-h-screen bg-white pb-20 detail-container">
      ...
      <div class="max-w-7xl mx-auto px-6 lg:px-8 mb-12">
        ...
        <h1 class="text-4xl md:text-5xl font-bold text-slate-900 mb-4 detail-title opacity-0">{{ service()?.title }}</h1>
        <p class="text-xl text-blue-600 font-medium detail-title opacity-0">{{ service()?.subtitle }}</p>
      </div>
      ...
      <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div class="lg:col-span-7 space-y-8">
             <div class="prose prose-lg text-slate-600 leading-relaxed detail-content opacity-0">
                @for (paragraph of service()?.content; track $index) {
                  <p class="mb-6">{{ paragraph }}</p>
                }
             </div>

             <div class="bg-blue-50 rounded-2xl p-8 border border-blue-100 detail-content opacity-0">
             ...
             <div class="pt-8 detail-content opacity-0">
          ...
          <!-- Sidebar Image -->
          <div class="lg:col-span-5 relative lg:sticky lg:top-32 h-fit detail-image opacity-0 scale-95">
...
export class ServiceDetailComponent implements AfterViewInit, OnDestroy {
  ...
  runAnimations() {
    ...
    setTimeout(() => {
        ...
        // Ensure initial positions for .to animations
        gsap.set('.detail-title', { y: 30 });
        gsap.set('.detail-content', { y: 30 });
        gsap.set('.detail-image', { scale: 0.95 });
